    ...
    <div className="m-[2px] border-2 border-solid border-gray-50 shadow-md rounded-[8px] p-4">
      <div className="flex flex-col items-center justify-between">
        ...
        <div className="mt-4 flex justify-end space-x-2 w-full">
          <button className="bg-[#3251D0] text-white  py-1 px-3 rounded-lg text-sm hover:bg-red-500 transition-all">
            Edit
          </button>
          <button className="bg-red-600 text-white py-1 px-3 rounded-lg text-sm hover:bg-red-500 transition-all">
            Delete
          </button>
        </div>
      </div>
